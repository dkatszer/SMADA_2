...
public class Breeder extends Agent {
	final static String studentsMail = "dkatszer@student.agh.edu.pl"; /// Preferred AGH's mail
	final static String studentsName = "Dominik";
	final static String studentsId = "266310";
	...
	private class ListenBehaviour extends CyclicBehaviour {
		public void action() {
			ACLMessage message = myAgent.blockingReceive(1000);
			if (message != null) {
